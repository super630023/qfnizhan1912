...
export default {
  ...
  methods: {
    ...
    ...mapMutations('shop', ['setCinemaId'])
  },
  mounted () {
    this.hide()
    axios.get(`/ajax/cinemaDetail?cinemaId=${this.$route.params.kerwinid}&optimus_uuid=650959A05E8E11EA86368DE7C885C7A019C2EFB8D33D436A8FA7FD77D18243D4&optimus_risk_level=71&optimus_code=10`).then(res => {
